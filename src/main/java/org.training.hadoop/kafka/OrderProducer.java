...
public class OrderProducer {
    ...
    static final String TOPIC_CLICK = "t_order";
...
//                "jdbc:presto://c7402:8080/hive/jd","vagrant", null);
        ...
        String sql = "select uid, buy_time, price, discount from t_order order by buy_time";
        ...
        while (res.next()) {
            ...
            System.out.println("Update user " + uid + " buy " + buy_time);
            //发送消息
            producer.send(new ProducerRecord<>(TOPIC_CLICK,
                    ""+uid, uid+ "," + price + "," + discount
            ));
            //延时10毫秒
            Thread.sleep(1000);
        }
        long stopTime = System.currentTimeMillis();
        System.out.println("buy time: " + (stopTime - startTime) + ", count : " + count);
    }
}
